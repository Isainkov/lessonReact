...
//         const rows = [];
//         console.log('daysOff' + this.daysOff[33]);
//         console.log('allDays' + this.props.allDays);
...
export function TableBody({teams, allDays, currentDate, width}) {
    console.log('Teams' + teams)

    return(
        teams.map((team) => <Team team ={team} key={team.name} allDays={allDays} currentDate={currentDate} width = {width}/>)
    );
}
